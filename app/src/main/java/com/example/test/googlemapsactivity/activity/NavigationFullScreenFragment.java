...
import com.example.test.googlemapsactivity.rest.DataParser;
...
*/
    ...
    public void onResume() {
        ...
        if (mapUtil.getCurPosition() != null && mapUtil.getDestination() != null) {
            System.out.println("mapUtil current position= " + mapUtil.getCurPosition());
            System.out.println("mapUtil.getDestination() = " + mapUtil.getDestination());
            //createPath();
        }
